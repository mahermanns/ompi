...
#define OPAL_HAVE_INLINE_ATOMIC_LOAD_STORE_32 0
#define OPAL_HAVE_INLINE_ATOMIC_LOAD_STORE_64 0
#else
...
#define OPAL_HAVE_INLINE_ATOMIC_LOAD_STORE_32 1
#define OPAL_HAVE_INLINE_ATOMIC_LOAD_STORE_64 1
#endif
